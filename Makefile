...
generate-build-cfg-pkg:
	...
	@echo "// SPDX-License-Identifier: BSD-2-Clause" > src/qeciphy_build_cfg_pkg.sv
	@echo "// This file defines build-time configuration parameters for the QECIPHY module." >> src/qeciphy_build_cfg_pkg.sv
	@echo "// Please do not edit this file directly. It may be overridden by the build flow." >> src/qeciphy_build_cfg_pkg.sv
	...
	@echo "INFO: Generated src/qeciphy_build_cfg_pkg.sv"

generate-sim-cfg-pkg:
	@echo "INFO: Generating simulation configuration package"
	@RCLK_PERIOD_NS=$$(echo "1000 / $(RCLK_FREQ)" | bc -l); \
	 FCLK_PERIOD_NS=$$(echo "1000 / $(FCLK_FREQ)" | bc -l); \
	 echo "// SPDX-License-Identifier: BSD-2-Clause" > tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "// This file defines configuration parameters for the QECIPHY testbench." >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "// Please do not edit this file directly. It may be overridden by the build flow." >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "" >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "\`ifndef QECIPHY_SIM_CFG_PKG" >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "\`define QECIPHY_SIM_CFG_PKG" >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "" >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "package qeciphy_sim_cfg_pkg;" >> tb/qeciphy_sim_cfg_pkg.sv; \
	 echo "" >> tb/qeciphy_sim_cfg_pkg.sv; \
	...
	@echo "INFO: Generated tb/qeciphy_sim_cfg_pkg.sv"
