...
create_generated_clock -name rx_clk    [get_pins -hierarchical -filter {NAME =~ *QECIPHY*i_qeciphy_gt_xilinx/gen_GTY_transceiver.i_BUFG_rx_clk/O}]
...
create_generated_clock -name tx_clk    [get_pins -hierarchical -filter {NAME =~ *QECIPHY*i_qeciphy_gt_xilinx/gen_GTY_transceiver.i_BUFG_tx_clk/O}]
