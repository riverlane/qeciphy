...
set_property PACKAGE_PIN AL37 [get_ports gt_refclk_in_n]
set_property PACKAGE_PIN AL36 [get_ports gt_refclk_in_p]
...
set_property IOSTANDARD LVCMOS18 [get_ports {led_l[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {led_l[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {led_l[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {led_l[3]}]
