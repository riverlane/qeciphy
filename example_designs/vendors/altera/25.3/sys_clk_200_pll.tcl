...
# create the system "sys_clk_200_pll"
proc do_create_sys_clk_200_pll {} {
	# create the system
	create_system sys_clk_200_pll
	...
	set_instance_parameter_value iopll_0 {gui_clock_name_string0} {axis_clk}
	...
	set_instance_parameter_value iopll_0 {gui_frac_multiply_factor} {0.0}
	set_instance_parameter_value iopll_0 {gui_fractional_cout} {24}
	...
	set_instance_parameter_value iopll_0 {gui_multiply_fraction} {0}
	...
	set_instance_parameter_value iopll_0 {gui_use_fractional_division} {0}
	set_instance_parameter_value iopll_0 {gui_use_locked} {1}
	set_instance_parameter_value iopll_0 {gui_use_logical} {0}
	set_instance_parameter_value iopll_0 {gui_use_slvs_refclk} {0}
	set_instance_parameter_value iopll_0 {gui_use_slvs_refclk1} {0}
...
<bonusData>
 <element __value="iopll_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	set_module_property FILE {sys_clk_200_pll.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {sys_clk_200_pll}

	# save the system
	sync_sysinfo_parameters
	save_system sys_clk_200_pll
}
