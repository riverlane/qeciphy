...
proc do_create_qeciphy_altera_clk_mmcm {} {
	# create the system
	create_system qeciphy_altera_clk_mmcm
...
<bonusData>
 <element __value="intelclkctrl_0">
  <datum __value="_sortIndex" value="0" type="int" />
	...
	set_module_property FILE {qeciphy_altera_clk_mmcm.ip}
	set_module_property GENERATION_ID {0x00000000}
	set_module_property NAME {qeciphy_altera_clk_mmcm}

	# save the system
	sync_sysinfo_parameters
	save_system qeciphy_altera_clk_mmcm
}
...
do_create_qeciphy_altera_clk_mmcm
